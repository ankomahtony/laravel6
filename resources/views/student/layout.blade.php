                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="avatar menu-avatar background-unset">
                                <img class="border-radius-none border-0 mr-3" alt="Akaunting" src="http://akaunting.test/public/img/akaunting-logo-white.svg">
                            </span>
                             ...
                             <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark dropdown-menu-right">
                                    <div class="row shortcuts px-4">
                                            ...
                                            <a href="http://akaunting.test/purchases/bills/create" class="col-4 shortcut-item">
                                                <span class="shortcut-media avatar rounded-circle bg-gradient-danger">
                                                <i class="fa fa-shopping-cart"></i>
                                                </span>
                                                <small class="text-danger">Project</small>
                                            </a>
                                        
                                        
                                            <a href="http://akaunting.test/purchases/payments/create" class="col-4 shortcut-item">
                                                <span class="shortcut-media avatar rounded-circle bg-gradient-danger">
                                                    <i class="fas fa-music"></i>
                                                </span>
                                                <small class="text-danger">Festival</small>
                                            </a>
                                        
                                        
                                            <a href="http://akaunting.test/purchases/vendors/create" class="col-4 shortcut-item">
                                                <span class="shortcut-media avatar rounded-circle bg-gradient-danger">
                                                <i class="fas fa-coins"></i>
                                                </span>
                                                <small class="text-danger">Contribution</small>
                                            </a>
                                        </div>
                                </div>
                            </li>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="text-sm float-left text-muted footer-texts">
                        Powered By Anthony Ankomah: <a href="https://akaunting.com" target="_blank" class="text-muted">Obokor Management System</a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
