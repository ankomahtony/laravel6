                ...
                <div class="container-fluid content-layout">
                    <div class="header-body">
                        <div class="row py-4 align-items-center">
                            <div class="col-xs-12 col-sm-9 col-md-9 align-items-center">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 align-items-right">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body d-grid">
                                <img src="/images/students/{{$student->picture}}" alt="Profile Pic" class="user-img" style='height:150px; width:auto'><br>
                                <a class="text-sm font-weight-600">Name</a>
                                <a class="text-xs long-texts">{{$student->last_name}}, {{$student->other_name}}</a> 
                                <div class="dropdown-divider"></div> 
                                <a class="text-sm font-weight-600">Index Number</a> 
                                <a class="text-xs long-texts">{{$student->index_number}}</a> 
                                <div class="dropdown-divider"></div> 
                                <a class="text-sm font-weight-600">Class</a> 
                                <a class="text-xs long-texts">{{$student->class}}</a> 
                                <div class="dropdown-divider"></div> 
                        ...
                        <a href="/students/{{$student->id}}/edit" class="btn btn-info btn-block edit-sv">
                            ...
                            <div class="col-md-4">
                                <div class="card card-stats">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <a href="/questions/1/edit">
                                                <h5>{{$exam->name}}</h5>
                                            </a></div><a href="/questions/1/edit"> 
                                            </a><div class="col-auto"><a href="/questions/1/edit">
                                                </a><a href="questions/2">
                                                    <div class="icon icon-shape bg-orange text-white rounded-circle shadow">
                                                        <button class="btn btn-sm btn-danger">{{$exam->status}}</button>
                                                    </div>
                                                </a>
                                            </div>
                                        </div> 
                                        <p class="mt-3 mb-0 text-sm">
                                            <span class="pre btn-warning"> <i class="fas fa-exclamation-triangle"></i> Once you start you can pause neither save to continue</span>
                                        
                                        </p>
                                    </div>
                                </div>
                            <div class="card-body">
                                <a href="/tests/{{$exam->id}}" class="btn btn-success btn-block edit-sv">
                                <i class="fas fa-plus"></i><b>Start Exams</b></a>
                            </div>
                            </div>
